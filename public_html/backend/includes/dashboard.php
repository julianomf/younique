...
function wp_dashboard_setup() {
	...
	//Blog da Logica
	add_action( 'wp_dashboard_setup', 'blog_dashboard_setup' );
	function blog_dashboard_setup() {
	    wp_add_dashboard_widget(
	        'blog-dashboard-widget',
	        'Blog Da L&oacute;gica Digital',
	        'blog_dashboard_content',
	        $control_callback = null
	    );
	}
	function blog_dashboard_content() {
	    echo '<div class="rss-widget">';  
		     wp_widget_rss_output(array(  
		          'url' => 'http://www.logicadigital.com.br/feed/',  //put your feed URL here  
		          'title' => 'Blog Da L&oacute;gica Digital',  
	  ...
	  // Sobre o Lettera CMS
	 function sobre_o_lettera_dashboard_widget_function() {
		  // Display whatever it is you want to show
		  echo "<p>Capaz de suportar desde intranets até portais de conteúdo, é um sistema escalonável que pode ser operado em diversos níveis, facilitando a organização do conteúdo e oferecendo inúmeras possibilidades de interatividade.<br/>Com interface fácil, o <strong>LetteraCMS</strong> permite edição visual de textos, imagens e da diagramação das páginas que serão publicados. Qualquer usuário acostumado a usar Editores de Texto consegue usar a ferramenta extraindo dela recursos avançados sem necessitar nenhum conhecimento de HTML ou outras linguagens de programação.<br/><br/><a href=\"http://letteracms.logicadigital.com.br\" title=\"Saiba mais sobre o LetteraCMS\">Saiba mais sobre o LetteraCMS</a></p>";
	  }
	// Create the function use in the action hook
	  function sobre_o_lettera_add_dashboard_widgets() {
		  wp_add_dashboard_widget('sobre_o_lettera_dashboard_widget', 'Sobre o LetteraCMS', 'sobre_o_lettera_dashboard_widget_function');
	  }
	  // Hoook into the 'wp_dashboard_setup' action to register our other functions
	  add_action('wp_dashboard_setup', 'sobre_o_lettera_add_dashboard_widgets' );
	...
	if ( 'POST' == $_SERVER['REQUEST_METHOD'] && isset($_POST['widget_id']) ) {
		...
		ob_start(); // hack - but the same hack backend/widgets.php uses
	...
	/** This action is documented in backend/edit-form-advanced.php */
	...
	<form name="post" action="<?php echo esc_url( admin_url( 'post.php' ) ); ?>" method="post" id="quick-press" class="initial-form hide-if-no-js">
		...
		<div class="input-text-wrap" id="title-wrap">
			<label class="screen-reader-text prompt" for="title" id="title-prompt-text">
				...
				<?php
				/** This filter is documented in backend/edit-form-advanced.php */
 ...
 * which is later replaced by Ajax call (see top of /backend/index.php)
 *
 * @since 2.5.0
 *
 * @param string $widget_id
