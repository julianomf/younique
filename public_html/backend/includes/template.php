...
require_once( ABSPATH . 'backend/includes/class-walker-category-checklist.php' );

/** WP_Internal_Pointers class */
require_once( ABSPATH . 'backend/includes/class-wp-internal-pointers.php' );
	...
	foreach ( (array) $terms as $term ) {
		...
		<li id="<?php echo $id; ?>" class="popular-category">
			<label class="selectit">
				...
				<?php
				/** This filter is documented in ldcms-includes/category-template.php */
...
function get_inline_data($post) {
	...
	/** This filter is documented in backend/edit-tag-form.php */
	echo '
...
<?php
/** This action is documented in backend/admin-header.php */
...
<?php
/** This filter is documented in backend/admin-header.php */
 ...
 */
if ( isset($GLOBALS['body_id']) ) echo ' id="' . $GLOBALS['body_id'] . '"'; ?> class="backend wp-core-ui no-js iframe <?php echo $admin_body_classes . ' ' . $admin_body_class; ?>">
<script type="text/javascript">
(function(){
...
function iframe_footer() {
	...
	<div class="hidden">
<?php
	/** This action is documented in backend/admin-footer.php */
...
<html xmlns="http://www.w3.org/1999/xhtml" class="<?php echo $admin_html_class; ?>" <?php
	/** This action is documented in backend/includes/template.php */
	do_action( 'admin_xml_ns' );
?> <?php language_attributes(); ?>>
<!--<![endif]-->
<head>
