 ...
 * (ldcms-conteudo/plugins) and in one directory above the plugins directory
 * (ldcms-conteudo/plugins/my-plugin). The file it looks for has the plugin data
...
function get_plugins($plugin_folder = '') {
	...
	// Files in ldcms-conteudo/plugins directory
 ...
 *
 * WordPress only includes mu-plugin files in the base mu-plugins directory (ldcms-conteudo/mu-plugins).
 *
 * @since 3.0.0
...
function get_mu_plugins() {
	$wp_plugins = array();
	// Files in ldcms-conteudo/mu-plugins directory
	$plugin_files = array();
...
/**
 * Check the ldcms-conteudo directory and retrieve all drop-ins with any plugin data.
 *
 * @since 3.0.0
...
function get_dropins() {
	...
	// These exist in the ldcms-conteudo directory
...
function delete_plugins( $plugins, $deprecated = '' ) {
	...
	if ( false === $credentials ) {
		if ( ! empty($data) ){
			include_once( ABSPATH . 'backend/admin-header.php');
			echo $data;
...
function add_submenu_page( $parent_slug, $page_title, $menu_title, $capability, $menu_slug, $function = '' ) {
	 ...
	 * See backend/admin.php for redirect from edit.php to tools.php
	 */
 ...
 *
 * @since 3.0.0
 * @since 4.4.0 Function was moved into the `backend/includes/plugin.php` file.
 *
