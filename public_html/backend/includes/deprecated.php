 ...
 * @since 1.5.0
 * @deprecated 2.9.0
 * @uses WP_CONTENT_DIR Full filesystem path to the ldcms-conteudo directory.
 *
 * @param string $file Filesystem path relative to the ldcms-conteudo directory.
...
function wp_update_core($current, $feedback = '') {
	...
	include( ABSPATH . 'backend/includes/class-wp-upgrader.php' );
