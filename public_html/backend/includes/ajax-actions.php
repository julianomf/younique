...
function wp_ajax_imgedit_preview() {
	...
	include_once( ABSPATH . 'backend/includes/image-edit.php' );
...
function wp_ajax_autocomplete_user() {
	...
	/** This filter is documented in backend/user-new.php */
...
function wp_ajax_dashboard_widgets() {
	require_once ABSPATH . 'backend/includes/dashboard.php';
...
function wp_ajax_add_menu_item() {
	...
	require_once ABSPATH . 'backend/includes/nav-menu.php';
	...
	/** This filter is documented in backend/includes/nav-menu.php */
...
function wp_ajax_inline_save() {
	...
	if ( ! empty( $data['tax_input'] ) ) {
		foreach ( $data['tax_input'] as $taxonomy => $terms ) {
			...
			/** This filter is documented in backend/includes/class-wp-posts-list-table.php */
...
function wp_ajax_save_widget() {
	...
	/** This action is documented in backend/widgets.php */
...
function wp_ajax_delete_inactive_widgets() {
	...
	/** This action is documented in backend/includes/ajax-actions.php */
	do_action( 'load-widgets.php' );
	/** This action is documented in backend/includes/ajax-actions.php */
	do_action( 'widgets.php' );
	/** This action is documented in backend/widgets.php */
...
function wp_ajax_save_attachment_compat() {
	...
	/** This filter is documented in backend/includes/media.php */
...
function wp_ajax_get_revision_diffs() {
	require ABSPATH . 'backend/includes/revision.php';
...
function wp_ajax_query_themes() {
	...
	/** This filter is documented in backend/includes/class-wp-theme-install-list-table.php */
...
function wp_ajax_crop_image() {
	...
	switch ( $context ) {
		case 'site-icon':
			...
			/** This filter is documented in backend/custom-header.php */
...
function wp_ajax_install_theme() {
	...
	include_once( ABSPATH . 'backend/includes/class-wp-upgrader.php' );
	include_once( ABSPATH . 'backend/includes/theme.php' );
...
function wp_ajax_install_plugin() {
	...
	include_once( ABSPATH . 'backend/includes/class-wp-upgrader.php' );
	include_once( ABSPATH . 'backend/includes/plugin-install.php' );
