	...
	function SwitchEditors() {
		...
		function scrollVisualModeToStartElement( editor, element ) {
			var elementTop = editor.$( element ).offset().top,
				...
				edTools = $( '#ldcms-conteudo-editor-tools' ),
				edToolsHeight = 0,
				edToolsOffsetTop = 0,
			 ...
			 * experience.
			 *
			 * In order to find the top of the editor, we calculate the offset of `#ldcms-conteudo-editor-tools` and
		 ...
		 * `ldcms-includes/js/tinymce/plugins/wordpress/plugin.js`.
		 *
