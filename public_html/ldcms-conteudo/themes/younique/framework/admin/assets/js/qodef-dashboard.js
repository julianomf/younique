    	...
    	if (galleries.length){
    		galleries.each(function(){
    			var thisGallery = $(this),
    				...
    				thisGalleryImageHolder = thisGallery.next().find('.qodef-dashboard-gallery-images-holder');
    	...
    	if (removeMediaBttns.length){
    		removeMediaBttns.each(function(){
    			var thisRemoveMedia = $(this),
    				removeImagesHolder = thisRemoveMedia.parents('.qodef-dashboard-gallery-uploader').next().find('.qodef-dashboard-gallery-images-holder'),
    				inputHiddenValue = thisRemoveMedia.siblings('.qodef-dashboard-media-hidden');

                console.log(thisRemoveMedia);
                console.log( thisRemoveMedia.parents('.qodef-dashboard-gallery-holder'));
