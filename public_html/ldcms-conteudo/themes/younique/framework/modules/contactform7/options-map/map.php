...
if ( ! function_exists('eiddo_qodef_contact_form_7_options_map') ) {

	function eiddo_qodef_contact_form_7_options_map() {
		
		eiddo_qodef_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'eiddo' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = eiddo_qodef_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'eiddo' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = eiddo_qodef_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'eiddo' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'eiddo' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = eiddo_qodef_add_admin_row(
			array(
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'eiddo' ),
			)
		);
		...
		$typography_text_row2 = eiddo_qodef_add_admin_row(
			array(
		...
		$typography_text_row3 = eiddo_qodef_add_admin_row(
			array(
		...
		$typography_label_group = eiddo_qodef_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'eiddo' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'eiddo' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = eiddo_qodef_add_admin_row(
			array(
		...
		$typography_label_row2 = eiddo_qodef_add_admin_row(
			array(
		...
		$background_border_group = eiddo_qodef_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'eiddo' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'eiddo' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = eiddo_qodef_add_admin_row(
			array(
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'eiddo' )
			)
		);
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'eiddo' )
			)
		);
		
		$background_border_row2 = eiddo_qodef_add_admin_row(
			array(
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'eiddo' ),
			)
		);
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'eiddo' )
			)
		);
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'eiddo' )
			)
		);
		
		$background_border_row3 = eiddo_qodef_add_admin_row(
			array(
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Width', 'eiddo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'eiddo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = eiddo_qodef_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'eiddo' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = eiddo_qodef_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'eiddo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'eiddo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'eiddo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'eiddo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = eiddo_qodef_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'eiddo' ),
				'description' => esc_html__( 'Setup form elements margin', 'eiddo' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = eiddo_qodef_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'eiddo' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'eiddo' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = eiddo_qodef_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'eiddo' ),
				'description' => esc_html__( 'Setup button text typography', 'eiddo' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = eiddo_qodef_add_admin_row(
			array(
		...
		$button_typography_row2 = eiddo_qodef_add_admin_row(
			array(
		...
		$button_background_border_group = eiddo_qodef_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'eiddo' ),
				'description' => esc_html__( 'Setup button background and border style', 'eiddo' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = eiddo_qodef_add_admin_row(
			array(
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'eiddo' )
			)
		);
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'eiddo' )
			)
		);
		
		$button_background_border_row2 = eiddo_qodef_add_admin_row(
			array(
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'eiddo' )
			)
		);
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'eiddo' )
			)
		);
		
		$button_background_border_row3 = eiddo_qodef_add_admin_row(
			array(
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'eiddo' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'eiddo' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = eiddo_qodef_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'eiddo')
		));

		//Text Typography

		$typography_text_group = eiddo_qodef_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'eiddo'),
			'description'	=> esc_html__('Setup typography for form elements text', 'eiddo'),
		...
		$typography_text_row1 = eiddo_qodef_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = eiddo_qodef_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = eiddo_qodef_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = eiddo_qodef_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'eiddo'),
			'description'	=> esc_html__('Setup typography for form elements label', 'eiddo'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = eiddo_qodef_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = eiddo_qodef_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = eiddo_qodef_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'eiddo'),
			'description'	=> esc_html__('Setup form elements background and border style', 'eiddo'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = eiddo_qodef_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = eiddo_qodef_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = eiddo_qodef_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = eiddo_qodef_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'eiddo'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = eiddo_qodef_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = eiddo_qodef_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'eiddo'),
			'description'	=> esc_html__('Setup form elements margin', 'eiddo'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = eiddo_qodef_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = eiddo_qodef_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'eiddo'),
			'description'	=> esc_html__('Setup button text typography', 'eiddo'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = eiddo_qodef_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = eiddo_qodef_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = eiddo_qodef_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'eiddo'),
			'description'	=> esc_html__('Setup button background and border style', 'eiddo'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = eiddo_qodef_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = eiddo_qodef_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = eiddo_qodef_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = eiddo_qodef_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'eiddo')
        ));
        ...
        $typography_label_row3 = eiddo_qodef_add_admin_row(array(
        ...
        $button_typography_row3 = eiddo_qodef_add_admin_row(array(
	...
	add_action( 'eiddo_qodef_options_map', 'eiddo_qodef_contact_form_7_options_map', 20);
}