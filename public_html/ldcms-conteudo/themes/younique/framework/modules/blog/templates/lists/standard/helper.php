...
if ( ! function_exists( 'eiddo_qodef_get_blog_holder_classes' ) ) {
	/**
	 * Function that generates blog holder classes for blog page
	 */
	function eiddo_qodef_get_blog_holder_classes( $classes ) {
	...
	add_filter( 'eiddo_qodef_blog_holder_classes', 'eiddo_qodef_get_blog_holder_classes' );
}
