...
class EiddoQodefSocialIconWidget extends EiddoQodefWidget {
	
	public function __construct() {
		parent::__construct(
			'qodef_social_icon_widget',
			esc_html__( 'Select Social Icon Widget', 'eiddo' ),
			array( 'description' => esc_html__( 'Add social network icons to widget areas', 'eiddo' ) )
		);
	...
	protected function setParams() {
		$this->params = array_merge(
			eiddo_qodef_icon_collections()->getSocialIconWidgetParamsArray(),
			array(
				array(
					'type'  => 'textfield',
					'name'  => 'link',
	...
	public function widget( $args, $instance ) {
		...
		<a class="qodef-social-icon-widget-holder qodef-icon-has-hover" <?php echo eiddo_qodef_get_inline_attr( $hover_color, 'data-hover-color' ); ?> <?php eiddo_qodef_inline_style( $icon_styles ) ?> href="<?php echo esc_url( $link ); ?>" target="<?php echo esc_attr( $target ); ?>">
