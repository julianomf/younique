...
class EiddoQodefIconWidget extends EiddoQodefWidget {
	public function __construct() {
		parent::__construct(
			'qodef_icon_widget',
			esc_html__( 'Select Icon Widget', 'eiddo' ),
			array( 'description' => esc_html__( 'Add icons to widget areas', 'eiddo' ) )
		);
	...
	protected function setParams() {
		$this->params = array_merge(
			eiddo_qodef_icon_collections()->getIconWidgetParamsArray(),
			array(
				array(
					'type'  => 'textfield',
					'name'  => 'icon_text',
					'title' => esc_html__( 'Icon Text', 'eiddo' )
				),
				array(
					'type'  => 'textfield',
					'name'  => 'link',
	...
	public function widget( $args, $instance ) {
		...
		$data   = array();
		$data[] = ! empty( $instance['icon_hover_color'] ) ? eiddo_qodef_get_inline_attr( $instance['icon_hover_color'], 'data-hover-color' ) : '';
		$data   = implode( ' ', $data );
		...
		if ( ! empty( $instance['icon_size'] ) ) {
			$holder_styles[] = 'font-size: ' . eiddo_qodef_filter_px( $instance['icon_size'] ) . 'px';
		}
		...
		<a <?php eiddo_qodef_class_attribute( $holder_classes ); ?> <?php echo wp_kses_post( $data ); ?> href="<?php echo esc_url( $link ); ?>" target="<?php echo esc_attr( $target ); ?>" <?php echo eiddo_qodef_get_inline_style( $holder_styles ); ?>>
