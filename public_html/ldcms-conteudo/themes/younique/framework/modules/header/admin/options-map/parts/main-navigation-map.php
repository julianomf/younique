...
if ( ! function_exists( 'eiddo_qodef_get_hide_dep_for_header_main_menu_options' ) ) {
	function eiddo_qodef_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'eiddo_qodef_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'eiddo_qodef_header_main_navigation_options_map' ) ) {
	function eiddo_qodef_header_main_navigation_options_map() {
		$hide_dep_options = eiddo_qodef_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = eiddo_qodef_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'eiddo' ),
		...
		eiddo_qodef_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'eiddo' )
			)
		);
		
		$drop_down_group = eiddo_qodef_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'drop_down_group',
				'title'       => esc_html__( 'Main Dropdown Menu', 'eiddo' ),
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'eiddo' )
			)
		);
		
		$drop_down_row1 = eiddo_qodef_add_admin_row(
			array(
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'eiddo' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'eiddo' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'eiddo' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'eiddo' )
				)
			)
		);
		...
		$first_level_group = eiddo_qodef_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'eiddo' )
			)
		);
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'eiddo' ),
			)
		);
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'eiddo' ),
			)
		);
		
		$first_level_row4 = eiddo_qodef_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'eiddo' ),
			)
		);
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'eiddo' ),
			)
		);
		
		$first_level_row5 = eiddo_qodef_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = eiddo_qodef_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = eiddo_qodef_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'eiddo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'eiddo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = eiddo_qodef_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'eiddo' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'eiddo' )
			)
		);
		...
		eiddo_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover/Active Color', 'eiddo' )
			)
		);
		...
		$second_level_wide_group = eiddo_qodef_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'eiddo' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'eiddo' )
			)
		);
		
		$second_level_wide_row1 = eiddo_qodef_add_admin_row(
			array(
		...
		$second_level_wide_row2 = eiddo_qodef_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = eiddo_qodef_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = eiddo_qodef_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'eiddo' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'eiddo' )
			)
		);
		...
		$third_level_row3 = eiddo_qodef_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_wide_group = eiddo_qodef_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'eiddo' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'eiddo' )
			)
		);
		
		$third_level_wide_row1 = eiddo_qodef_add_admin_row(
			array(
		...
		$third_level_wide_row2 = eiddo_qodef_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = eiddo_qodef_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'eiddo_qodef_header_main_navigation_options_map', 'eiddo_qodef_header_main_navigation_options_map', 10, 1 );
}