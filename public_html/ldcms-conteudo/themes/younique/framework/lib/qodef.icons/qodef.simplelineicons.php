...
class EiddoQodefSimpleLineIcons implements iEiddoQodefIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'eiddo'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'eiddo'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'eiddo'),
            'icon-social-facebook'    => esc_html__('Facebook', 'eiddo'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'eiddo'),
            'icon-social-github'      => esc_html__('Github', 'eiddo'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'eiddo'),
            'icon-social-instagram'   => esc_html__('Instagram', 'eiddo'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'eiddo'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'eiddo'),
            'icon-social-reddit'      => esc_html__('Reddit', 'eiddo'),
            'icon-social-skype'       => esc_html__('Skype', 'eiddo'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'eiddo'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'eiddo'),
            'icon-social-spotify'     => esc_html__('Spotify', 'eiddo'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'eiddo'),
            'icon-social-twitter'     => esc_html__('Twitter', 'eiddo'),
            'icon-social-youtube'     => esc_html__('Youtube', 'eiddo')
        );
    }
