...
if($row_content_width === 'grid'){
	$qodef_row_wrapper_start .= '<div class="qodef-row-grid-section-wrapper '.esc_attr($grid_row_classes).'" '.esc_attr($grid_row_datas).' ' . eiddo_qodef_get_inline_style( $qodef_grid_row_styles ) . '><div class="qodef-row-grid-section">';
...
$output .= '<div ' . implode( ' ', $wrapper_attributes ) . ' ' . eiddo_qodef_get_inline_style( $qodef_vc_row_styles ) . '>';
