    ...
    function qodef_re_property_ajax_save_query() {
        if ( empty( $_POST ) || ! isset( $_POST ) ) {
            qodef_re_ajax_status(
                'error',
                esc_html__( 'All fields are empty, search parameters are not saved.', 'select-real-estate' ),
                ''
            );
        } else {
            $data = $_POST;
            ...
            $html .= '<span class="qodef-undo-query-save" data-query-id="' . $index . '">';
                $html .= '<span class="qodef-undo-query-message">';
                    $html .= esc_html__('Undo', 'select-real-estate');
                $html .= '</span>';
            ...
            qodef_re_ajax_status(
                'success',
                esc_html__( 'Query successfully saved.', 'select-real-estate' ),
                $html
            );
        }
    }
...
if( !function_exists('qodef_re_property_ajax_remove_query') ) {
    function qodef_re_property_ajax_remove_query() {
        if ( empty( $_POST ) || ! isset( $_POST ) ) {
            qodef_re_ajax_status(
                'error',
                esc_html__( 'No query saved to be undone.', 'select-real-estate' ),
                ''
            );
        } else {
            $data = $_POST;
            ...
            qodef_re_ajax_status(
                'success',
                esc_html__( 'Query successfully removed.', 'select-real-estate' ),
                $html
            );
        }
    }
