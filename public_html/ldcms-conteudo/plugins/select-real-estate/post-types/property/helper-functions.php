...
if (!function_exists('qodef_re_get_property_specification_items')) {
    function qodef_re_get_property_specification_items($item_id = '') {
        ...
        $item['label'] = esc_html__('Tipo do imóvel:', 'select-real-estate');
        ...
        $item['label'] = esc_html__('Área útil:', 'select-real-estate');
        ...
        $item['label'] = esc_html__('Quartos:', 'select-real-estate');
        ...
        $item['label'] = esc_html__('Banheiros:', 'select-real-estate');
        ...
        $item['label'] = esc_html__('Piso:', 'select-real-estate');
		...
		*/
        ...
        $item['label'] = esc_html__('Total de pisos:', 'select-real-estate');
		...
		*/
        ...
        $item['label'] = esc_html__('Ano de construção:', 'select-real-estate');
        ...
        $item = array();
        $item['icon'] = '<img src="' . qodef_re_get_assets_icon_src('icon-heating', 'png') . '" alt="' . esc_attr__('Property heating icon', 'select-real-estate') . '"/>';
        $item['label'] = esc_html__('Aquecedor:', 'select-real-estate');
        $item['value'] = get_post_meta($item_id, 'qodef_property_heating_meta', true);
        $specification_items[] = $item;
		*/
        ...
        $item['label'] = esc_html__('Suites:', 'select-real-estate');
...
if (!function_exists('qodef_re_get_property_additional_specification_items')) {
    function qodef_re_get_property_additional_specification_items($item_id = '') {
        ...
        $item['label'] = esc_html__('Mobiliado:', 'select-real-estate');
        ...
        $item['label'] = esc_html__('Garagem:', 'select-real-estate');
        ...
        $item['label'] = esc_html__('Área de lazer:', 'select-real-estate');
        ...
        $item['label'] = esc_html__('Do centro:', 'select-real-estate');
        ...
        $item['label'] = esc_html__('Data de publicação:', 'select-real-estate');
        ...
        $item['label'] = esc_html__('Garagens:', 'select-real-estate');
        ...
        $item['label'] = esc_html__('Garagens tamanho:', 'select-real-estate');
        ...
        if (empty($_POST) || !isset($_POST) || !isset($_POST['data'])) {
            ...
            if (wp_verify_nonce($nonce, 'qodef_re_validate_property_item_enquiry')) {
                ...
                if ($error) {
                    ...
                    $mail_sent = wp_mail(
                        $mail_to, //Mail To
                        esc_html__('New Enquiry Form', 'select-real-estate'), //Subject
