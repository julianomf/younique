...
function wpseo_auto_load( $class ) {
	...
	if ( $classes === null ) {
		$classes = array(
			'wp_list_table'   => ABSPATH . 'backend/includes/class-wp-list-table.php',
			'walker_category' => ABSPATH . 'ldcms-includes/category-template.php',
			'pclzip'          => ABSPATH . 'backend/includes/class-pclzip.php',
		);
	}
