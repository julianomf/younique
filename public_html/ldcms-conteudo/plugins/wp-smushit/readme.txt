...
<a href="https://garage.godaddy.com/wordpress-plugin-partner-program/directory/?cvosrc=advocacy.evangelism.WP3" rel="nofollow"><img src="https://garage.godaddy.com/arquivos/badges/godaddy-plugin-partner-program-badge.svg" title="GoDaddy Plugin Program Partner" alt="GoDaddy Plugin Program Partner"/></a>
...
1. Upload the `wp-smush` plugin to your `/ldcms-conteudo/plugins/` directory.
...
* Fixed:
    ...
    * S3 config error if AWS keys are defined in sys4.9.4/ldcms-config.php
