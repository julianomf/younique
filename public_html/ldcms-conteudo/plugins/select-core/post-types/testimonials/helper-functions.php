...
if ( ! function_exists( 'qodef_core_testimonials_meta_box_functions' ) ) {
	...
	add_filter( 'eiddo_qodef_meta_box_post_types_save', 'qodef_core_testimonials_meta_box_functions' );
	add_filter( 'eiddo_qodef_meta_box_post_types_remove', 'qodef_core_testimonials_meta_box_functions' );
}
