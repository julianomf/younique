...
class SectionTitle implements Lib\ShortcodeInterface
{
                ...
                array(
                    ...
                    'params'                    => array(
                        ...
                        array(
                            'type'        => 'textfield',
                            'param_name'  => 'label',
                            'heading'     => esc_html__('Label', 'select-core'),
                            'admin_label' => true
                        ),
                        array(
                            'type'        => 'textfield',
    ...
    private function getTextStyles($params) {
        ...
        if (!empty($params['text_font_size'])) {
            $styles[] = 'font-size: ' . eiddo_qodef_filter_px($params['text_font_size']) . 'px';
        }

        if (!empty($params['text_line_height'])) {
            $styles[] = 'line-height: ' . eiddo_qodef_filter_px($params['text_line_height']) . 'px';
        }
        ...
        if ($params['text_margin'] !== '') {
            $styles[] = 'margin-top: ' . eiddo_qodef_filter_px($params['text_margin']) . 'px';
        }
