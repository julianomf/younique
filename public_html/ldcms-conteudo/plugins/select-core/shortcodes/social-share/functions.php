...
if ( ! function_exists( 'eiddo_qodef_get_social_share_html' ) ) {
	/**
	 ...
	 * @return mixed|string
	 */
	function eiddo_qodef_get_social_share_html( $params = array() ) {
		if ( eiddo_qodef_core_plugin_installed() ) {
			return eiddo_qodef_execute_shortcode( 'qodef_social_share', $params );
		}
	}
}

if ( ! function_exists( 'eiddo_qodef_the_excerpt_max_charlength' ) ) {
	/**
	 ...
	 */
	function eiddo_qodef_the_excerpt_max_charlength( $charlength ) {
		$twitter_via_meta = eiddo_qodef_options()->getOptionValue( 'twitter_via' );
