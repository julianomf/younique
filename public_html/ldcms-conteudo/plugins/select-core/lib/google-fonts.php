<?php
if ( ! function_exists( 'eiddo_qodef_init_google_fonts_array' ) ) {
    function eiddo_qodef_init_google_fonts_array() {
        ...
        $eiddo_qodef_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'eiddo_qodef_init_google_fonts_array');
}