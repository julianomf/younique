...
if ( ! function_exists( 'eiddo_qodef_add_user_custom_fields' ) ) {
	/**
	 * Function creates custom social fields for users
	 *
	 * return $user_contact
	 */
	function eiddo_qodef_add_user_custom_fields( $user_contact ) {
		/**
	...
	add_filter( 'user_contactmethods', 'eiddo_qodef_add_user_custom_fields' );
}
...
if ( ! function_exists( 'qodef_core_set_open_graph_meta' ) ) {
	...
	function qodef_core_set_open_graph_meta() {
		...
		if ( eiddo_qodef_option_get_value( 'enable_open_graph' ) === 'yes' ) {
			...
			if ( eiddo_qodef_is_woocommerce_installed() && ( function_exists( 'is_shop' ) && is_shop() ) ) {
			...
			if ( ! empty( $id ) ) {
				...
				if ( get_post_thumbnail_id( $id ) !== '' ) {
					...
					$image = eiddo_qodef_option_get_value( 'open_graph_image' );
				}
			} else {
				global $wp;
	...
	add_action( 'eiddo_qodef_header_meta', 'qodef_core_set_open_graph_meta' );
}