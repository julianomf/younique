		...
		<div class="rs-dash-widget" id="system_dw">
			...
			<div class="rs-dash-widget-inner">
				...
				if($writeable_boolean){
					...
					echo '<i class="revredicon eg-icon-cancel"></i><span style="margin-left:16px" class="rs-dash-more-info" data-title="'.__('Error with File Permissions', 'revslider').'" data-content="'.__('Please set write permission (755) to your arquivos folders to make sure the Slider can save all updates and imports in the future.', 'revslider').'"><i class="eg-icon-info"></i></span>';
				}
				?>
