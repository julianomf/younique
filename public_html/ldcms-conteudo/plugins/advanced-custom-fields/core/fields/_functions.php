	...
	*/
	...
	function update_value( $value, $post_id, $field )
	{
		...
		else
		{
			...
			// update_metadata -> http://core.trac.wordpress.org/browser/tags/3.4.2/ldcms-includes/meta.php#L82: line 101 (does use stripslashes_deep)
			// update_option -> http://core.trac.wordpress.org/browser/tags/3.5.1/ldcms-includes/option.php#L0: line 215 (does not use stripslashes_deep)
			$value = stripslashes_deep($value);
