...
if ( get_option( 'ossdl_off_include_dirs' ) === false ) {
	add_option( 'ossdl_off_include_dirs', 'ldcms-conteudo,ldcms-includes' );
}
...
function scossdl_off_update() {
	...
	if ( isset( $_POST['action'], $_POST['_wpnonce'] )
		...
		update_option( 'ossdl_off_include_dirs', $_POST['ossdl_off_include_dirs'] == '' ? 'ldcms-conteudo,ldcms-includes' : $_POST['ossdl_off_include_dirs'] );
		...
		<table class="form-table"><tbody>
			...
			<tr valign="top">
				...
				<td>
					...
					<span class="description"><?php _e( 'Directories to include in static file matching. Use a comma as the delimiter. Default is <code>ldcms-conteudo, ldcms-includes</code>, which will be enforced if this field is left empty.', 'wp-super-cache' ); ?></span>
				</td>
			</tr>
			<tr valign="top">
