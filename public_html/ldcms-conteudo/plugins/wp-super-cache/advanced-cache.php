...
function wpcache_broken_message() {
	...
	if ( false == strpos( $_SERVER['REQUEST_URI'], 'backend' ) && ! $skip_output ) {
		echo '<!-- WP Super Cache is installed but broken. The constant WPCACHEHOME must be set in the file sys4.9.4/ldcms-config.php and point at the WP Super Cache plugin directory. -->';
	}
}
