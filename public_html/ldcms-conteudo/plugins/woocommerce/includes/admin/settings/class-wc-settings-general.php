		...
		$settings = apply_filters(
			'woocommerce_general_settings', array(
				...
				array(
					...
					'desc_tip' => __( 'This option determines a customers default location. The MaxMind GeoLite Database will be periodically downloaded to your ldcms-conteudo directory if using geolocation.', 'woocommerce' ),
					'default'  => 'geolocation',
					'type'     => 'select',
					'class'    => 'wc-enhanced-select',
