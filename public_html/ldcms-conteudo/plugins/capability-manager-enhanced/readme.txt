...
= 1.5.3 =
  ...
  * Fixed : CSS caused formatting issues around backend Update button on some installations
  * Perf : Don't output backend CSS on non-CME screens
...
= 1.4.10 =
  * Perf :  Eliminated unused framework code (reduced typical backend memory usage by 0.6 MB)
