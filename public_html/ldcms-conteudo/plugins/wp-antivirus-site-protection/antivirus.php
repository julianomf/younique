...
class SGAntiVirus_SQL_scanner
{
	...
	{
        if (file_exists(SCAN_PATH.'sys4.9.4/ldcms-config.php') && file_exists(SCAN_PATH.'ldcms-includes'.DIRSEP.'version.php')) return 'wordpress';
	...
	public function GetSQLsettings($cms = '')
	{
        ...
        {
            case 'wordpress':
                $config_file = SCAN_PATH.'sys4.9.4/ldcms-config.php';
	...
	public function scanner($check_session = true, $show_results = true)
	{
		...
		if (count($exclude_folders))
		{
            ...
            if (defined('SCAN_ALL_SITES') && SCAN_ALL_SITES == 1) 
            {
                ...
                {
                	if ( file_exists( $scan_path.DIRSEP.$folder.DIRSEP."configuration.php" ) || file_exists( $scan_path.DIRSEP.$folder.DIRSEP."sys4.9.4/ldcms-config.php" ) )
                	{
