...
abstract class WC_Product_Qodef_Abstract extends WC_Abstract_Legacy_Product {
	...
	public function get_image_id( $context = 'view' ) {
		return eiddo_qodef_get_attachment_id_from_url($this->get_image());
	}
    ...
    public function single_add_to_cart_text() {
        return apply_filters( 'qodef_wci_' . $this->get_object_type() . '_single_add_to_cart_text', esc_html__( 'Add to cart', 'select-checkout' ), $this );
    }
    ...
    public function add_to_cart_text() {
        return apply_filters( 'qodef_wci_' . $this->get_object_type() . '_product_add_to_cart_text', esc_html__( 'Read more', 'select-checkout' ), $this );
    }
