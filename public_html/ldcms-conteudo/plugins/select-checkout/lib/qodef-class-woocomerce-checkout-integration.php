...
/**
 * Class QodefWoocommerceCheckoutIntegration
 */
class QodefWoocommerceCheckoutIntegration {
	/**
	 * @var QodefWoocommerceCheckoutIntegration - instance of current class
	 */
	...
	/**
	 * @return QodefWoocommerceCheckoutIntegration
	 */
	...
	public function supported_post_types() {
		return apply_filters( 'qodef_woocommerce_checkout_integration_post_types', array() );
	}
...
add_action( 'plugins_loaded', array( 'QodefWoocommerceCheckoutIntegration', 'getInstance' ) );