...
?>
	<div class="lwa lwa-default"><?php //class must be here, and if this is a template, class name should be that of template directory ?>
        <form class="lwa-form" action="<?php echo esc_attr(LoginWithAjax::$url_login); ?>" method="post">
            ...
            <table>
                <tr class="dev.bomvac.com.br">
                    <tr class="dev.bomvac.com.br-label">
                        <label style="font-weight:bold;font-size:15px;width:100%;display:block"><br><?php esc_html_e( 'Username','login-with-ajax' ) ?></label>
                    </tr>
                    <tr class="dev.bomvac.com.br-input">
                        <input style="border: 1px solid #ddd;height:40px;width:80%;" type="text" name="log" />
                    </tr>
                </tr>
                <tr class="lwa-password">
                    <tr class="lwa-password-label">
                        <label style="font-weight:bold;font-size:15px;width:100%;display:block"><br><?php esc_html_e( 'Password','login-with-ajax' ) ?></label>
                    </tr>
                    <tr class="lwa-password-input">
                        <input style="border: 1px solid #ddd;height:40px;width:80%;" type="password" name="pwd" />
                    </tr>
                </tr>
