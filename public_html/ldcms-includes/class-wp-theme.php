...
final class WP_Theme implements ArrayAccess {
	...
	/**
	 * Absolute path to the theme root, usually ldcms-conteudo/themes
	 *
	 * @var string
	 */
	private $theme_root;
	...
	/**
	 * URL to the theme root, usually an absolute URL to ldcms-conteudo/themes
	 *
	 * @var string
	 */
	...
	public function __construct( $theme_dir, $theme_root, $_child = null ) {
		...
		if ( is_array( $cache ) ) {
			...
			// Properly identify default themes that are inside a directory within ldcms-conteudo/themes.
		...
		if ( ! is_array( $cache ) && $this->template != $this->stylesheet && ! file_exists( $this->theme_root . '/' . $this->template . '/index.php' ) ) {
			...
			// ldcms-conteudo/themes/directory-of-themes/*
	 ...
	 *
	 * This is typically the absolute path to ldcms-conteudo/themes.
	 *
	 * @since 3.4.0
	 *
	 ...
	 *
	 * This is typically the absolute URL to ldcms-conteudo/themes. This forms the basis
	...
	public static function get_allowed_on_site( $blog_id = null ) {
		...
		/** This filter is documented in ldcms-includes/class-wp-theme.php */
		return (array) apply_filters( 'site_allowed_themes', $allowed_themes[ $blog_id ], $blog_id );
	}
