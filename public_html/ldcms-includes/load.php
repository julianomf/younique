 ...
 * All three can be defined in sys4.9.4/ldcms-config.php. By default, `WP_DEBUG` and
	...
	if ( !defined( 'WP_LANG_DIR' ) ) {
		if ( file_exists( WP_CONTENT_DIR . '/languages' ) && @is_dir( WP_CONTENT_DIR . '/languages' ) || !@is_dir(ABSPATH . WPINC . '/languages') ) {
			...
			if ( !defined( 'LANGDIR' ) ) {
				...
				define( 'LANGDIR', 'ldcms-conteudo/languages' );
			}
		} else {
			/**
			 * Server path of the language directory.
...
function wp_set_wpdb_vars() {
	...
	if ( is_wp_error( $prefix ) ) {
		wp_load_translations_early();
		wp_die(
			/* translators: 1: $table_prefix 2: sys4.9.4/ldcms-config.php */
 ...
 *
 * If an object-cache.php file exists in the ldcms-conteudo directory,
...
function wp_not_installed() {
	if ( is_multisite() ) {
		...
		$link = wp_guess_url() . '/backend/install.php';
 ...
 *
 * The default directory is ldcms-conteudo/mu-plugins. To change the default
 ...
 *
 * The default directory is ldcms-conteudo/plugins. To change the default
...
function wp_load_translations_early() {
	...
	while ( true ) {
		...
		if ( @is_dir( ABSPATH . 'ldcms-conteudo/languages' ) )
			$locations[] = ABSPATH . 'ldcms-conteudo/languages';
