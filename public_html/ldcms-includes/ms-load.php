 ...
 *
 * The default directory is ldcms-conteudo/plugins. To change the default directory
 * manually, define `WP_PLUGIN_DIR` and `WP_PLUGIN_URL` in `sys4.9.4/ldcms-config.php`.
 *
 * @access private
 * @since 3.1.0
 *
 ...
 * use the ldcms-conteudo/blog-deleted.php, blog-inactive.php and
...
function ms_load_current_site_and_network( $domain, $path, $subdomain = false ) {
	...
	// If the network is defined in sys4.9.4/ldcms-config.php, we can simply use that.
	...
	if ( empty( $current_site ) ) {
		/** This action is documented in ldcms-includes/ms-settings.php */
		do_action( 'ms_network_not_found', $domain, $path );
