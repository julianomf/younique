...
/** This action is documented in ldcms-includes/feed-rss2.php */
...
<feed
	...
	<?php
		/** This action is documented in ldcms-includes/feed-atom.php */
		do_action( 'atom_ns' );
	...
	<entry>
		<title><?php
			if ( !is_singular() ) {
				...
				/** This filter is documented in ldcms-includes/feed.php */
