...
function get_locale() {
	...
	/** This filter is documented in ldcms-includes/l10n.php */
	return apply_filters( 'locale', $locale );
}
 ...
 * the translation file from `ldcms-conteudo/languages`, removing the need
 ...
 *
 * Looks in the ldcms-conteudo/languages directory for translations of
 * plugins or themes.
 *
 * @since 3.7.0
 *
