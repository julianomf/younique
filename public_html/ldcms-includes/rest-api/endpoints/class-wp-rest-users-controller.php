...
class WP_REST_Users_Controller extends WP_REST_Controller {
	...
	public function update_item( $request ) {
		...
		/** This action is documented in ldcms-includes/rest-api/endpoints/class-wp-rest-users-controller.php */
	 ...
	 *
	 * Performs a couple of checks like edit_user() in backend/includes/user.php.
	 *
	 * @since 4.7.0
	 *
