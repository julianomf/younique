...
function _print_emoji_detection_script() {
	...
	if ( SCRIPT_DEBUG ) {
		$settings['source'] = array(
			/** This filter is documented in ldcms-includes/class.wp-scripts.php */
 ...
 *
 * @since 1.2.0
 * @since 4.4.0 Moved to ldcms-includes/formatting.php from backend/includes/misc.php and added $length param.
 *
