...
class WP_Http {
	...
	private function _dispatch_request( $url, $args ) {
		...
		/** This action is documented in ldcms-includes/class-http.php */
	 ...
	 *
	 * You block external URL requests by defining WP_HTTP_BLOCK_EXTERNAL as true in your sys4.9.4/ldcms-config.php
