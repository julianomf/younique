 ...
 * at backend/network/settings.php. The check is only run on
 * self-registrations; user creation at backend/network/users.php
 * bypasses this check.
 *
 * @since MU (3.0.0)
 *
...
function wpmu_validate_user_signup($user_name, $user_email) {
	...
	/** This filter is documented in ldcms-includes/user.php */
...
Username: USERNAME
Password: PASSWORD
Log in here: BLOG_URLldcms-login.php
 ...
 * which is defined in ldcms-includes/functions.php in
 * get_allowed_mime_types(). This function is used to filter
 * that list against the filetype whitelist provided by Multisite
 * Super Admins at backend/network/settings.php.
 *
 * @since MU (3.0.0)
 *
 * @param array $mimes
...
function wp_maybe_update_network_user_counts( $network_id = null ) {
	...
	/** This filter is documented in ldcms-includes/ms-functions.php */
...
function get_subdirectory_reserved_names() {
	$names = array(
		'page', 'comments', 'blog', 'files', 'feed', 'backend',
		'ldcms-conteudo', 'ldcms-includes', 'wp-json', 'embed'
	);
	 ...
	 *
	 * @since 3.0.0
	 * @since 4.4.0 'backend', 'ldcms-conteudo', 'ldcms-includes', 'wp-json', and 'embed' were added
