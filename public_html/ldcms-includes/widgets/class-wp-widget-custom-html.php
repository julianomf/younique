...
class WP_Widget_Custom_HTML extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		/** This filter is documented in ldcms-includes/widgets/class-wp-widget-pages.php */
		...
		/** This filter is documented in ldcms-includes/widgets/class-wp-widget-text.php */
