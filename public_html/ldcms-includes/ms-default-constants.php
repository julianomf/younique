 ...
 * ldcms-includes/ms-files.php (ldcms-conteudo/blogs.php in MU).
 *
 * @since 3.0.0
 */
function ms_upload_constants() {
	...
	if ( !defined( 'UPLOADBLOGSDIR' ) )
		define( 'UPLOADBLOGSDIR', 'ldcms-conteudo/blogs.dir' );

	// Note, the main site in a post-MU network uses arquivos.
	...
	if ( ! defined( 'UPLOADS' ) ) {
		...
		if ( 'ldcms-conteudo/blogs.dir' == UPLOADBLOGSDIR && ! defined( 'BLOGUPLOADDIR' ) )
...
function ms_subdomain_constants() {
	...
	if ( $subdomain_error ) {
		$vhost_deprecated = sprintf(
			/* translators: 1: VHOST, 2: SUBDOMAIN_INSTALL, 3: sys4.9.4/ldcms-config.php, 4: is_subdomain_install() */
